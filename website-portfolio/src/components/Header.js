      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <Nav.Link href="/ArmandoResume.pdf" target="_blank" className={`fs-5 mx-3 d-inline-block rounded px-3 py-2 ${isDarkMode ? 'border-White wh-White' : 'border-Black wh-Black'}`}>Resume</Nav.Link>
