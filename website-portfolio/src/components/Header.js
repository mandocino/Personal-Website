...
const Header = () => {
  return (
    <Navbar id="nav" bg="dark" variant="dark" expand="lg" className="fixed-top">
      <Container>
        <Navbar.Brand href="#nav">Armando Mancino</Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            <Nav.Link href="#welcome" className="text-white fs-5">Home</Nav.Link>
            <Nav.Link href="#about" className="text-white fs-5">About</Nav.Link>
            <Nav.Link href="#portfolio" className="text-white fs-5">Portfolio</Nav.Link>
            <Nav.Link href="#skills" className="text-white fs-5">Skills</Nav.Link>
